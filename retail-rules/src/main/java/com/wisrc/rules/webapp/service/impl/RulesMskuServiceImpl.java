...
import com.wisrc.rules.webapp.dto.msku.GetMskuInfoDTO;
import com.wisrc.rules.webapp.dto.msku.MskuInfoDTO;
import com.wisrc.rules.webapp.service.MskuOutsideService;
...
@Service
public class RulesMskuServiceImpl implements RulesMskuService {
    @Autowired
