...
public class WarehouseManageInfoDTO {
    ...
    @ApiModelProperty(value = "仓库类型(A--本地仓，B--海外仓，C--虚拟仓，F--FBA仓)")
    ...
    private List<WarehouseSeparateDetailsInfoDTO> subWarehouseList;


    public WarehouseManageInfoDTO() {
        this.subWarehouseList = new ArrayList<>();
    }

    public List<WarehouseSeparateDetailsInfoDTO> getSubWarehouseList() {
        return subWarehouseList;
    }

    public void setSubWarehouseList(List<WarehouseSeparateDetailsInfoDTO> subWarehouseList) {
