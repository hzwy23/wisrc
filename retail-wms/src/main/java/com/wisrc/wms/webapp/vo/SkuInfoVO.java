...
public class SkuInfoVO {
    ...
    @ApiModelProperty("入备品数")
    private Integer inSpareQuantity;
    @ApiModelProperty("批次")
    ...
    public Integer getInSpareQuantity() {
        return inSpareQuantity;
    }

    public void setInSpareQuantity(Integer inSpareQuantity) {
        this.inSpareQuantity = inSpareQuantity;
    }
