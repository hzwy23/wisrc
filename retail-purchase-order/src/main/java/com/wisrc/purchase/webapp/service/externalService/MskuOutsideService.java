...
@FeignClient(value = "retail-purchase-operation-12", url = "http://localhost:8080")
public interface MskuOutsideService {
    ...
    @RequestMapping(value = "/operation/merchandise/product/status", method = RequestMethod.GET)
    Result getSkuId(@RequestParam("saleStatusList") List<String> saleStatusList) throws Exception;
}
