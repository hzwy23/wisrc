...
import com.wisrc.crawler.webapp.utils.Toolbox;
...
//
//    @Override
//    public Result findImageByKey(String obsName, String key) {
//        Map<String,Object> map = new HashMap<>();
//
//        try {
//            ObsClient obsClient = new ObsClient(ak, sk, endPoint);
//            ObsObject obsObject = obsClient.getObject(obsName, key);
//            BufferedImage bufferedImage = ImageIO.read(obsObject.getObjectContent());
//            String type = obsObject.getMetadata().getContentType();
//            map.put("data", bufferedImage);
...
//            e.printStackTrace();
//        } catch (ObsException e) {
//            logger.error("获取图片资源失败，失败原因是：{}， 使用本地友情提示图片返回给客户端",e.getMessage());
//        }
//        map.put("data",localImageBuffer);
//        map.put("contentType","png");
//        return Result.failure(ResultCode.NO_IMAGE, map);
//    }
