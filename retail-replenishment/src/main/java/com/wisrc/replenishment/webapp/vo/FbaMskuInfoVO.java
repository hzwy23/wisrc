...
public class FbaMskuInfoVO {
    ...
    public String toString() {
        return "FbaMskuInfoVO{" +
                "replenishmentCommodityId='" + replenishmentCommodityId + '\'' +
                ", mskuId='" + mskuId + '\'' +
                ...
                ", fnsku='" + fnsku + '\'' +
                ", mskupackList=" + mskupackList +
                ", declareUnitPrice=" + declareUnitPrice +
                ", mskuUnitCd=" + mskuUnitCd +
                ", declarationElements='" + declarationElements + '\'' +
                ", mskuInfoVO=" + mskuInfoVO +
                ", mskuTypeCd=" + mskuTypeCd +
                '}';
    }
}
