...
public class CompanyCustomsInfoVO {
    @ApiModelProperty("标识字段1标识补货单，2标识调拨单")
    ...
    @ApiModelProperty(value = "报关资料产品信息列表")
    private List<CustomsProductListVO> productListVOList;
    ...
    public List<CustomsProductListVO> getProductListVOList() {
        return productListVOList;
    }

    public void setProductListVOList(List<CustomsProductListVO> productListVOList) {
